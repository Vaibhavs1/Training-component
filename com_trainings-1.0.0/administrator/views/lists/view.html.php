 ...
 * @since  1.6
 */
class TrainingsViewLists extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		TrainingsHelper::addSubmenu('lists');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_TRAININGS_TITLE_LISTS'), 'lists.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_trainings&view=lists');
	}
