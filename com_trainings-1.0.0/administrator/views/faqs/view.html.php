 ...
 * @since  1.6
 */
class TrainingsViewFaqs extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		TrainingsHelper::addSubmenu('faqs');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_TRAININGS_TITLE_FAQS'), 'faqs.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('faqs.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_trainings&view=faqs');
	}
